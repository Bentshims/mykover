...
const plansData = {
  basique: {
    ...
    price: '15',
    currency: '$',
    description: 'Le Plan Basique, à seulement 15 $/mois, couvre toute la famille (jusqu\'à 3 membres).',
    features: [
  ...
  libota: {
    ...
    price: '30',
    currency: '$',
    description: 'Le Plan Libota, à seulement 30 $/mois, couvre toute la famille (jusqu\'à 5 membres).',
    features: [
  ...
  premium: {
    ...
    price: '50',
    currency: '$',
    description: 'Le Plan Premium, à seulement 50 $/mois, couvre toute la famille (jusqu\'à 7 membres).',
    features: [
  ...
  const handleSubscribe = async (planKey: string) => {
    ...
    try {
      ...
      if (response.success && response.data?.payment_url) {
        ...
        const result = await WebBrowser.openBrowserAsync(response.data.payment_url, {
        ...
        throw new Error(response.message || 'Échec de l\'initialisation du paiement')
      }
    } catch (error: any) {
      Alert.alert(
        'Erreur de paiement',
        error.message || 'Impossible d\'initialiser le paiement. Veuillez réessayer.',
        [{ text: 'OK' }]
      )
    } finally {
      // Clear loading state
    ...
    <SafeAreaView className="flex-1 bg-gray-100">
      ...
      <View className="px-6 py-4">
        ...
        <Text className="leading-6 text-gray-600">
          ...
          Avec MyKover Assurance, accédez à des soins de santé abordables et fiables pour toute la famille. Consultations illimitées, hospitalisation et assistance d'urgence 24/7
        </Text>
      </View>
