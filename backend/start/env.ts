...
export default await Env.create(new URL('../', import.meta.url), {
  ...
  |----------------------------------------------------------
  */
  // Railway utilise DATABASE_URL, développement local utilise les variables séparées
  ...
  */
  ...
  /*
  |----------------------------------------------------------
  | Variables for SMS provider
  |----------------------------------------------------------
  */
  SMS_PROVIDER_API_KEY: Env.schema.string(),
  SMS_PROVIDER_API_SECRET: Env.schema.string(),
